...
DTS = DatasetMethods(dataset_path='spam.csv')

# Find min, max, avg for a specific column
# print(DTS.find_max_min_avg_length('Text'))

# Rename to match the previous dataset
# DTS.rename_column_in_csv('Message', 'Text')
# DTS.rename_column_in_csv('Category', 'Spam')
# DTS.rename_column_in_csv('Spam', 'SpamCategorical')
...
# print(DTS.split_dataset(stratify_column='Spam'))